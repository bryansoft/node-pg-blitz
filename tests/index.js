...
//
// var engine = pgBlitz.initialize().then(function(engin){
//
//   engine.newDb().then(function(connection) {
//     connection.
//   })
// })
//
...
// var oldQuery = Client.prototype.query
...
//
//   if (!client._schema) {
//     return oldQuery.apply(client, ["create schema if not exists " + session.get("schema")])
//       .then(function () {
//         return oldQuery.apply(client, ["set search_path to " + session.get("schema")])
//       })
//       .then(function () {
//         client._schema = session.get('schema')
//       })
//       .then(originalQuery)
//   }
...
function load(client) {
  ...
  return schemaInit(client)
    ...
    .then(function () {
      return client.query("set search_path to " + session.get("schema"))
    })
    .then(function(){
      return client
    })
...
function executeTest() {
  ...
  pool.connect()
    .then(function (client) {
      ...
      return load(client).then(function() { return client })
    }).then(function (client) {
...
//
// client.query("select ___LETS_TRY_THIS()").then(function () {
//   var done = new Date().getTime()
//   console.log("NewSchema: " + (done - start))
//   client.end()
// }).catch(function(e) {console.error(e)})

// client.query("select clone_schema('public', 'coolness2')").then(function () {
//   var done = new Date().getTime()
//   console.log("NewSchema: " + (done - start))
//   client.end()
// }).catch(function(e) {console.error(e)})
...
// client.query(citySchema, function(err, res) {
//   client.query(countrySchema, function(err, res) {
//     client.query(languageSchema, function (err, res) {
//       console.log("Query!")
